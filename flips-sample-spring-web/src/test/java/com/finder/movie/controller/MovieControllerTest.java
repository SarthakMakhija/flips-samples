...
public class MovieControllerTest {
    ...
    public void shouldGetFeatureNotEnabledOnMoviesByReleaseYear() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/movies/2016"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage", Matchers.equalTo("Feature not enabled, identified by method public java.util.List com.finder.movie.controller.MovieController.getMoviesByReleaseYear(int)")))
    ...
    public void shouldGetFeatureNotEnabledOnMoviesByGenre() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/movies/genres/ACTION"))
                .andExpect(MockMvcResultMatchers.status().is(501))
                .andExpect(MockMvcResultMatchers.jsonPath("$.errorMessage", Matchers.equalTo("Feature not enabled, identified by method public java.util.List com.finder.movie.controller.MovieController.getMoviesByGenre(com.finder.movie.model.Movie$Genre)")))
                .andExpect(MockMvcResultMatchers.jsonPath("$.className",    Matchers.equalTo("com.finder.movie.controller.MovieController")))
